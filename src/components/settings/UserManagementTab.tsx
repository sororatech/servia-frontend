  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      {items.map((item) => (
        <div
          key={item.label}
          className="rounded-2xl border border-[var(--color-warm-border)] bg-white dark:bg-[var(--color-warm-surface)] p-6 shadow-sm hover:shadow-md transition-shadow"
        >
...
export default function UserManagementTab({
  ...
  if (isEmpty) {
    return (
      <div className="rounded-2xl border border-[var(--color-warm-border)] bg-white dark:bg-[var(--color-warm-surface)] p-12 text-center shadow-sm">
        ...
        <h3 className="text-lg font-semibold text-[var(--color-foreground)]">No User Data Available</h3>
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h2 className="mb-4 text-2xl font-bold text-[var(--color-foreground)]">Candidates</h2>
