...
import { getRecruiterHeaders, isUserAdmin } from '@/lib/serverAuth'; // 👈 import isUserAdmin
  ...
  return (
    <main className="min-h-screen bg-page-gradient px-4 py-8 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-lg text-[var(--color-text-muted)]">
              {isAdmin 
                ? "View all interviews across all recruiters." 
                : "Track and manage your interview pipeline, sorted by scheduled date."}
            </p>
          </div>
          {/* 👇 Now this will correctly hide for admins */}
          {!isAdmin && <ScheduleInterviewButton />}
        </div>
        ...
        <ShortlistedCandidates candidates={shortlisted} isAdmin={isAdmin} />
